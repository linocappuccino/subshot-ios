...
extension AppLanguage {
    static let ideasStrings: [String: [String: String]] = [
        "de": [
            ...
            "ideaEditSheet.slashHint": "Tippe „/“ für Szene/Zwischenschritt (oder für Beschreibung/Titel/Dialog innerhalb einer Szene). Zweimal Enter schliesst den Block ab.",
            // 2026-07-27, Todoist #356 — internes Review-Gate (separat von
            // Abgenommen unten, welches der KUNDEN-seitige Entscheid ist).
            "ideaEditSheet.internalReviewSectionLabel": "Interne Prüfung",
            "ideaEditSheet.internalReviewPending": "Intern noch nicht abgenommen",
            "ideaEditSheet.internalApprove": "Intern abnehmen",
            "ideaEditSheet.internalReject": "Intern ablehnen",
            "ideaEditSheet.internalApprovedBy": "Intern abgenommen von {name} · {when}",
            "ideaEditSheet.internalRejectedBy": "Intern abgelehnt von {name} · {when}",
        ...
        "en": [
            ...
            "ideaEditSheet.slashHint": "Type “/” for a scene/intermediate step (or for description/title/dialogue inside a scene). Press Enter twice to close the block.",
            "ideaEditSheet.internalReviewSectionLabel": "Internal review",
            "ideaEditSheet.internalReviewPending": "Not internally approved yet",
            "ideaEditSheet.internalApprove": "Internally approve",
            "ideaEditSheet.internalReject": "Internally reject",
            "ideaEditSheet.internalApprovedBy": "Internally approved by {name} · {when}",
            "ideaEditSheet.internalRejectedBy": "Internally rejected by {name} · {when}",
            "ideaEditSheet.feedbackSectionLabel": "Feedback",
