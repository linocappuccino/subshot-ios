...
/// (opacity 0.03→0.07→0.03, 3.6s cycle) after Lino's "nur aussen glowen und
/// nicht so stark wie jetzt" correction, dimmed twice more 2026-07-15
/// ("immer noch zu hell" both times — was 0.06→0.18, then 0.05→0.11).
